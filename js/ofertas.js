$(document).ready(function(){
	$.ajax({
	 ...
	 $.ajax({
	 	...
	 	var car3= '<a href="product.html?id='+data.product.id+'"> <img src="'+data.product.imageUrl[0]+'"alt="Zapatos" class="img_carousel"><div class="carousel-caption"><h1>Camisas</h1></div></a>';
